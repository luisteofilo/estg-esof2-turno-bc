...
namespace ESOF.WebApp.DBLayer.Migrations
{
    ...
    [Migration("20240625214029_AddEventAndTasteEvaluationTables")]
    partial class AddEventAndTasteEvaluationTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = new Guid("99611bb2-580a-4192-9cf2-b70a9aa4227f"),
                            Name = "Event1",
                            Slug = "event1"
                        },
                        new
                        {
                            EventId = new Guid("0953701b-dbde-4d52-8eb6-88c2c317516e"),
                            Name = "Event2",
                            Slug = "event2"
                        },
                        new
                        {
                            EventId = new Guid("60db056b-f39e-4943-89ab-0b2bb8a93a8f"),
                            Name = "Event3",
                            Slug = "event3"
                        },
                        new
                        {
                            EventId = new Guid("bcae7da7-671c-4051-bb26-6fc3eb5d0b95"),
                            Name = "Event4",
                            Slug = "event4"
                        },
                        new
                        {
                            EventId = new Guid("0c86cf2b-8d9f-453d-bc29-c628a38b0ea9"),
                            Name = "Event5",
                            Slug = "event5"
                        });
                });
