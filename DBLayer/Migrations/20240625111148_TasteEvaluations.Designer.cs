...
namespace ESOF.WebApp.DBLayer.Migrations
{
    ...
    [Migration("20240625111148_TasteEvaluations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.TasteEvaluationQuestion", b =>
                {
                    ...
                    b.Property<Guid?>("TasteQuestionOptionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TasteQuestionOptionId");
            ...
            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.TasteQuestionOption", b =>
                {
                    b.Property<Guid>("TasteQuestionOptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("TasteQuestionOptionId");

                    b.HasIndex("TasteQuestionId");

                    b.ToTable("TasteQuestionOption");
                });

            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.TasteQuestionsType", b =>
                {
                    b.Property<Guid>("TasteQuestionsTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("gen_random_uuid()");
                    ...
                    b.HasKey("TasteQuestionsTypeId");

                    b.ToTable("TasteQuestionsTypes");
                });
            ...
            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.TasteEvaluationQuestion", b =>
                {
                    b.HasOne("ESOF.WebApp.DBLayer.Entities.TasteEvaluation", "TasteEvaluation")
                        .WithMany("TasteEvaluationQuestions")
                    ...
                    b.HasOne("ESOF.WebApp.DBLayer.Entities.TasteQuestionOption", "TasteQuestionOption")
                        .WithMany()
                        .HasForeignKey("TasteQuestionOptionId");

                    b.Navigation("TasteEvaluation");

                    b.Navigation("TasteQuestion");

                    b.Navigation("TasteQuestionOption");
                });

            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.TasteQuestion", b =>
                {
                    b.HasOne("ESOF.WebApp.DBLayer.Entities.Event", "Event")
                        .WithMany("TasteQuestions")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ESOF.WebApp.DBLayer.Entities.TasteQuestionsType", "QuestionType")
                        .WithMany("TasteQuestions")
            ...
            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.TasteEvaluation", b =>
                {
                    b.Navigation("TasteEvaluationQuestions");
                });
