            ...
            modelBuilder.Entity("ESOF.WebApp.DBLayer.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = new Guid("1aecc6df-a69d-4f26-901e-1dd95bd79b16"),
                            Name = "Event1",
                            Slug = "event1"
                        },
                        new
                        {
                            EventId = new Guid("147e30bd-66a9-4cee-8a76-25cd3277d8b9"),
                            Name = "Event2",
                            Slug = "event2"
                        },
                        new
                        {
                            EventId = new Guid("c2677a41-a1b2-412d-8672-5db26a586a43"),
                            Name = "Event3",
                            Slug = "event3"
                        },
                        new
                        {
                            EventId = new Guid("8d0ef506-181b-4f9f-b168-accb67ea4020"),
                            Name = "Event4",
                            Slug = "event4"
                        },
                        new
                        {
                            EventId = new Guid("7437e2e7-9e45-41a8-836b-207d24dbf766"),
                            Name = "Event5",
                            Slug = "event5"
                        });
                });
